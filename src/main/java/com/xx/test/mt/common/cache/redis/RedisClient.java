...
public class RedisClient {
	...
	private void KeyOperate() {
		...
		System.out.println("clear all data in redis:" + jedis.flushDB());
		// judge key if exist
		System.out.println("judge key 999 if exists:" + shardedJedis.exists("key999"));
		// new add key paire:key001,value001
		String retVal = shardedJedis.set("key001", "value001");
		System.out.println("新增key001,value001键值对:" + retVal);
